...
class UIManager:
    ...
    def _init_history(self):
        self.history_files = {
            "default": self.FileHistory(".dx_history_default"),
            "paths": self.FileHistory(".dx_history_paths"),
            "bouquet": self.FileHistory(".dx_history_bouquet"),
            "freq": self.FileHistory(".dx_history_freq"),
            "pid": self.FileHistory(".dx_history_pid"),
            "sid": self.FileHistory(".dx_history_sid"),
            "provider": self.FileHistory(".dx_history_provider")
        }
 ...
 |__   __|__ \     |  \/  |_ _| | | | | | | | | | |  \/  |/ \ |_   _| ____|
    ...
    |_|   |___|    |_|  |_|___|  \___/ \___/ \___/|_|  /_/   \_\|_| |_____|
               ...
               v10.1 - [ THE ENCYCLOPEDIA ARCHITECT ]
    """)
...
class SatelliteArchitect:
    ...
    def step_build(self):
        ...
        sid_hex = format(self.sid, 'x').lower()
    ...
    def _process_single_plp(
        ...
        self._map_csv_channels(pid, plp, ns_hex, tsid_hex, onid_hex)

    def _map_csv_channels(self, pid, plp, ns_hex, tsid_hex, onid_hex):
